...
export default function AddNewLead() {
  ...
  // ✅ ADDED: Generic select handler (no capitalizeFirst — preserves option values as-is)
  ...
  const buildPayload = (): LeadPayload => {
    ...
    return {
      ...
      lead_status: "new",
      // ✅ ADDED
      referral_department: form.referralDepartment || null,
    };
  };
    ...
    try {
      ...
      if (recipientEmail) {
        ...
        const emailBody = [
          ...
          `- Referral Department: ${payload.referral_department || "-"}`,
