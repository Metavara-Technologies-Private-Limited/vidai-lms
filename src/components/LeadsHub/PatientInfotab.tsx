    ...
    <Box sx={{ flex: 2, minWidth: 0 }}>
      ...
      >
        ...
        <Stack spacing={2.5} mb={2}>
          ...
          {/*
           * Contracts: show Lead Generated By and Referral Department in this section
           * Medical: not shown here
           * — Uses standard 3-column InfoGrid to align with rows above/below
           */}
          {IS_CONTRACTS_APP && (
            <InfoGrid>
              <InfoCell
          ...
          <>
            ...
            <InfoGrid sx={{ mb: 2 }}>
              ...
              <InfoCell
                label="DESIGNATION"
                value={
                  (lead as unknown as Record<string, string>).designation ||
                  "N/A"
                }
              />
              <InfoCell
                label="CONTACT NO"
                value={
                  (lead as unknown as Record<string, string>).contact_phone ||
                  leadPhone
                }
              />
              <InfoCell
                label="EMAIL"
                value={
                  (lead as unknown as Record<string, string>).contact_email ||
                  leadEmail
                }
                truncate={false}
              />
