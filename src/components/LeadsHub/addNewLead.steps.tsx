...
>>>>>>> Stashed changes
  ...
  return (
    <Box>
        ...
        <Box sx={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 2, mb: 4 }}>
          ...
          <Box>
            ...
            <TextField select fullWidth size="small" value={form.marital} onChange={handleSelectChange("marital")} sx={inputStyle}>
              {/* Values must match LeadChoices.MARITAL_STATUS exactly: "married" | "single" */}
            ...
            <Box sx={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 2, mb: 4 }}>
              ...
              <Box>
                ...
                <TextField select fullWidth size="small" value={form.partnerGender} onChange={handleSelectChange("partnerGender")} sx={inputStyle}>
                  {/* Values must match LeadChoices.GENDER exactly: "male" | "female" */}
                  <MenuItem value="">-- Select --</MenuItem>
                  <MenuItem value="male">Male</MenuItem>
                  <MenuItem value="female">Female</MenuItem>
                </TextField>
      ...
      {/* Row 1: Assigned To | Lead Generated By | Referral Dept | Next Action Type */}
      <Box
        sx={{
          display: "grid",
...
>>>>>>> Stashed changes
      ...
      {/* Row 2: Lead Status | Next Action Status */}
      <Box
        sx={{
          display: "grid",
          gridTemplateColumns: IS_CONTRACTS_APP ? "repeat(4, 1fr)" : "repeat(3, 1fr)",
      ...
      >
        {/* Lead Status
            ⚠️  Values MUST exactly match LeadChoices.LEAD_STATUS DB keys.
                The model uses spaces (e.g. "follow up"), NOT underscores.
                Do NOT change these values — the backend normalizer also
                handles the underscore→space conversion as a safety net,
                but the source of truth is the DB choice key.
        */}
        <Box>
          <Typography sx={labelStyle}>
            Lead npm Status{" "}
          ...
          >
            ...
            <MenuItem value="cycle_conversion">Cycle Conversion</MenuItem>
