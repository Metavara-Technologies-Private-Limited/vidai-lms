...
export function Step1({
  ...
  return (
    <Box>
      ...
      {/* Row 2: Medical app — Gender, Age, Marital Status, Address */}
      {IS_MEDICAL_APP && (
        <Box
          sx={{
            display: "grid",
      ...
      {/* ── CONTACT INFORMATION — contracts app only ─────────── */}
      {IS_CONTRACTS_APP && (
        <>
          <Typography
            variant="subtitle2"
      ...
      >
        ...
        {/* Referral Department — moved here, next to Lead Generated By */}
        {IS_CONTRACTS_APP && (
          <Box>
            ...
            <TextField
              ...
              onChange={onReferralDepartmentChange}
              sx={inputStyle}
            >
              <MenuItem value="">-- None --</MenuItem>
              {REFERRAL_DEPARTMENT_OPTIONS.map((opt) => (
