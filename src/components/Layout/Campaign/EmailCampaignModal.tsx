...
// import type { Campaign, EmailCampaignPayload } from "../../../types/campaigns.types";
...
//   /* ================= STEP 3 – SCHEDULE ================= */
//   const [scheduleRange, setScheduleRange] = useState<[Dayjs | null, Dayjs | null]>([null, null]);
...
//     try {
//       const start = scheduleRange[0] ? scheduleRange[0].format("YYYY-MM-DD") : null;
//       const end = scheduleRange[1] ? scheduleRange[1].format("YYYY-MM-DD") : null;
...
//       const res = await CampaignAPI.createEmail(payload);

//       // Build Campaign object to return to parent
//       const created: Campaign = {
//         id: res.data?.id ?? String(Date.now()),
//         name: campaignName,
//         description: campaignDescription,
//         type: "email",
//         status: (status === CAMPAIGN_STATUS.SCHEDULED ? "Scheduled" : "Draft") as Campaign["status"],
//         start: startDate,
//         end: endDate,
//         platforms: ["gmail"],
//         leads: 0,
...
//           {step === 2 && (
//             <div className="step-content">
//               <Typography variant="h6" sx={{ mb: 3 }}>Email Setup</Typography>
...
//                     <Select value={audience} label="Audience List *" onChange={(e) => setAudience(e.target.value)}>
...
//           {step === 3 && (
//             <div className="step-content">
//               <Typography variant="h6" sx={{ mb: 3 }}>Schedule Email</Typography>
...
//             {step === 3 ? (
//               <>
//                 <button className="next-btn" style={{ background: "#E5E7EB", color: "#111" }} onClick={() => handleSave("Draft")}>
//                   Save as Draft
//                 </button>
//                 <button className="next-btn" onClick={() => handleSave("Scheduled")}>Schedule</button>
//               </>
//             ) : (
